...
func printVersion(log *logrus.Entry) {
...
func main() {
	...
	err = leader.Become(ctx, "kerberus-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
	...
	// Setup Scheme for crd resources
	if err := extapi.AddToScheme(mgr.GetScheme()); err != nil {
		log.Error(err, "")
		os.Exit(1)
	}

	if err := kscheme.AddToScheme(mgr.GetScheme()); err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
