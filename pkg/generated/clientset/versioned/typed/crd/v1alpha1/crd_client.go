...
import (
	...
	"github.com/kerberushq/kerberus/pkg/generated/clientset/versioned/scheme"
...
func (c *CrdV1alpha1Client) CRDConfigs(namespace string) CRDConfigInterface {
	return newCRDConfigs(c, namespace)
}

func (c *CrdV1alpha1Client) CRDRequests(namespace string) CRDRequestInterface {
	return newCRDRequests(c, namespace)
}
