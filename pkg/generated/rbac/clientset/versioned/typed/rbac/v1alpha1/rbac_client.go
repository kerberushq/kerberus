...
import (
	...
	"github.com/kerberushq/kerberus/pkg/generated/rbac/clientset/versioned/scheme"
...
type RbacV1alpha1Interface interface {
	...
	NamespacePermissionsGetter
}

// RbacV1alpha1Client is used to interact with features provided by the rbac.kerberus.io group.
type RbacV1alpha1Client struct {
	restClient rest.Interface
}

func (c *RbacV1alpha1Client) NamespacePermissions(namespace string) NamespacePermissionInterface {
	return newNamespacePermissions(c, namespace)
}
