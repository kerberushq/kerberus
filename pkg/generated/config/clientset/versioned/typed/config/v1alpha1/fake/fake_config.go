...
var configsResource = schema.GroupVersionResource{Group: "crd.kerberus.io", Version: "v1alpha1", Resource: "configs"}

var configsKind = schema.GroupVersionKind{Group: "crd.kerberus.io", Version: "v1alpha1", Kind: "Config"}
...
func (c *FakeConfigs) UpdateStatus(config *v1alpha1.Config) (*v1alpha1.Config, error) {
	obj, err := c.Fake.
