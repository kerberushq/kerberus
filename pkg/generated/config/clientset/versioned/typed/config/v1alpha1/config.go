...
type ConfigInterface interface {
	...
	UpdateStatus(*v1alpha1.Config) (*v1alpha1.Config, error)
...
func newConfigs(c *CrdV1alpha1Client, namespace string) *configs {
	return &configs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *configs) UpdateStatus(config *v1alpha1.Config) (result *v1alpha1.Config, err error) {
	result = &v1alpha1.Config{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("configs").
